...
const wallet = new FileSystemWallet('/Users/jerryzhong/.fabric-vscode/wallets/local_fabric_wallet/');
...
async function main() {
    ...
    try {
        ...
        let fpath = fs.readFileSync('/Users/jerryzhong/.fabric-vscode/runtime/gateways/local_fabric.json', 'utf8');
